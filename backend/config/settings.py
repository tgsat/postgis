...
MIDDLEWARE = [
    ...
    "apps.rbac.middleware.AuditMiddleware",
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "gisdb"),
        "USER": os.environ.get("POSTGRES_USER", "postgres"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "postgres"),
        "HOST": os.environ.get("POSTGRES_HOST", "postgis"),
        "PORT": os.environ.get("POSTGRES_PORT", "5432"),
        "OPTIONS": {"options": "-c search_path=public,gis"},
    }
}
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "apps.rbac.permissions.IsAuthenticatedSystem",
    ),
...
SYSTEM_INITIALIZED_CACHE_KEY = "SYSTEM_INITIALIZED"
